...
arcade.draw_ellipse_filled(370,320,24,45,open_color.black)
arcade.draw_ellipse_filled(425,320,24,45,open_color.black)
arcade.draw_circle_filled(372,333,3,open_color.gray_2)
arcade.draw_circle_filled(427,333,3,open_color.gray_2)

#(x,y,width,height,color,start_degrees,end_degrees,border_thickness)
arcade.draw_arc_outline(400,270,50,40,open_color.black,190,350,4)
